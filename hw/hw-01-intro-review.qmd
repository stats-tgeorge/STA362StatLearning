...
-   Go to our RStudio Server at <{{< var server.url >}}>
...
-   Finding the instructions on our website: <{{< var course.url >}}>

-   Going to our RStudio Server at <{{< var server.url >}}>
...
There are a couple of very good sources of information that you may have forgotten. If you were lost on the homework, I **HIGHLY** recommend completing all of these!
