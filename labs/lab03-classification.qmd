...
#### Answer the following in questions 2 through 5:
...
6. Use the above code to fit all models at once and them compare them according to accuracy, ROC, and ROC AUC. 


# Submission

When you are finished, Render the final document. Once rendered, you can download your file by:

-   Make sure all students who worked on the lab's names are at the top. 
