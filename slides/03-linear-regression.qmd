...
Create a new **R project** file for this chapter. 
...
* In previous classes, this may have been referred to as SSE (sum of squares error), the book uses RSS, so we will stick with that!
...
* There are many ways "model fit" can be assessed. Three common ones are:
  * Residual Standard Error (RSE)
  * $R^2$ - percentage of variability of the response variable explained by the model
...
To see all metrics available see the yardstick docs: <https://yardstick.tidymodels.org/articles/metric-types.html>
...
## Additional Linear Regression Topics {.smaller}
