...
subtitle: "Multinomial Logisitc, LDA, QDA (maybe)"
format: 
  revealjs:
    output-file: "04-2-mlog-lda.html"
    slide-number: true
  html:
    output-file: "04-2-mlog-lda_o.html"
---
...
## Other LDS Interpretation {.smaller}
...
- Prior probabilities
  - These shows us updated estimates of $\hat{\pi}_1$, $\hat{\pi}_2$, etc.
...
- Group means
  - These are the averages of the predictors within each class. 
  - Estimates of $\mu_1$, $\mu_2$ etc.
...
- Coefficients of linear discriminants
  - These are the coefficients of the linear combination of the predictors used to form the LDA decision rule 

## Other LDS Interpretation {.smaller}

- Using the base R plot we can get the linear discriminants
