...
## Lasso (left) vs Ridge (right) Graphs

![](img/ridge_vs_lasso_graph.png)



## Lasso Performance {.smaller}
...
## Ridge vs Lasso $R^2$ vs MSE {.smaller}
...
- Comparison of squared bias (black), variance (green) and test MSE (purple)
- Lasso (solid) and Ridge (dashed). 
- Both are plotted against their $R^2$ on the training data
...
## Lasso $\lambda$ vs MSE Ex 2 {.smaller}
...
## Ridge vs Lasso $R^2$ vs MSE Ex 2 {.smaller}
...
- Lasso (solid) and Ridge (dashed)
- Plotted against their $R^2$ on the training data
