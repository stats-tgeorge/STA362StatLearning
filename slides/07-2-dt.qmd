...
subtitle: "Decision Trees: Bagging and Random Forests"
format: 
  revealjs:
...
* Mathematically, how does this work? Let's go back to intro to stat!
...
- These approaches will predict better but we no longer have a single representation fo the tree. 
