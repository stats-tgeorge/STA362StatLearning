...
subtitle: "Decision Trees: Boosting"
format: 
  revealjs:
...
## Boosting for Regression Trees {.smaller}
...
* `tidymodels` will handle this for us, but if you are interested in learning more, you can check out [Chapter 10.9 of Elements of Statistical Learning](https://hastie.su.domains/ElemStatLearn/)
